...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post user_infos_url, params: { user_info: { address: @user_info.address, name: @user_info.name, tel: @user_info.tel, user_id: @user_info.user_id } }
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { address: @user_info.address, name: @user_info.name, tel: @user_info.tel, user_id: @user_info.user_id } }
