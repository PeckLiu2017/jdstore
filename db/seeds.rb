...
Photo.create!(product_id:1,avatar: open(File.join('public/images/boiler-1.jpg')))
Photo.create!(product_id:2,avatar: open(File.join('public/images/cleaner-robot-1.jpg')))
Photo.create!(product_id:3,avatar: open(File.join('public/images/rice-cooker-1.png')))
